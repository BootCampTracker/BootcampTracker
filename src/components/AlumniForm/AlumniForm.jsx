  ...
  return (
    <FormControl>
      <Box>
        ...
        <div>
        <label>Date</label>
        <TextField type="date" placeholder="Graduation Date" />
        </div>
      </Box>
      <Box>
      ...
      <Box>
        ...
        <RadioGroup row aria-labelledby="health-insurance-radio-group">
        ...
        <RadioGroup row aria-labelledby="dental-insurance-radio-group">
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
          <FormControlLabel value="no" control={<Radio />} label="No" />
        </RadioGroup>
        <FormLabel id="pto-radio-group">PTO</FormLabel>
        <RadioGroup row aria-labelledby="pto-radio-group">
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
          <FormControlLabel value="no" control={<Radio />} label="No" />
        </RadioGroup>
        <FormLabel id="401k-radio-group">Health Insurance</FormLabel>
        <RadioGroup row aria-labelledby="401k-radio-group">
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
          <FormControlLabel value="no" control={<Radio />} label="No" />
        </RadioGroup>
        ...
        <RadioGroup row aria-labelledby="lt-diability-radio-group">
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
          <FormControlLabel value="no" control={<Radio />} label="No" />
        </RadioGroup>
        ...
        <RadioGroup row aria-labelledby="st-diability-radio-group">
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
          <FormControlLabel value="no" control={<Radio />} label="No" />
        </RadioGroup>
