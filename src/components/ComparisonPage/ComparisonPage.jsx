...
function ComparisonPage() {
  ...
  return (
    <>
      ...
      <Typography
        variant="h2"
        sx={{ fontSize: 20, marginBottom: 8, textAlign: "center" }}
      >
      ...
      <Grid container>
        ...
        >
          ...
          <Card
            sx={{ minWidth: 275, maxWidth: 500, backgroundColor: "#bbdefb" }}
            variant="outlined"
          >
            <CardContent sx={{ backgroundColor: "white", margin: 2 }}>
              ...
              <Typography variant="body2">
                ...
                Disability.
                <br />
                {averageEquity}% {job ? `of ${job}s` : ""} receive an Equity
                option.
                <br />
                The average yearly bonus {job ? `of ${job}s` : ""} is $
                {averageBonus}
                <br />
